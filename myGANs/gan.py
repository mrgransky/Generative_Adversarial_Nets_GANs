...
# in Local laptop:
# python gan.py --rgbDIR $HOME/datasets/sentinel2-l1c_RGB_IMGs --resDIR $HOME/datasets/GANs_results/misc
...
def train(init_gen_model=None, init_disc_model=None):
	...
	# loss fcn:
	criterion = torch.nn.BCELoss() # since we have sigmoid at the final layer of Discriminator
